...
# jsondata='{"app_id":"10004","client_id":"70000","temp":{"P1":"1"}}'
jsondata = sys.argv[1]
print(jsondata)
print(type(jsondata))
...
out=json_to_markdown(jsondata,None,errname='问题')
...
def fasong(json):
    ...
    url='https://oapi.dingtalk.com/robot/send?access_token=284397cd7ac0a0ab6dc522fe1492b640f35ca8be6c3b9753452a8040d29f55ab'
