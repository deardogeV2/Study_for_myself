...
public class BlogController {
    ...
    public Result queryFollowComments(@RequestParam(value = "lastId") Long max, @RequestParam(value = "offset", defaultValue = "0") Integer offset){
        return blogService.queryFollowComments(max,offset);
    }
}
