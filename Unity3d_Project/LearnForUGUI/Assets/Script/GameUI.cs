...
public class GameUI : SingletonMono<GameUI> {
    ...
    private ItemMsg itemInfo;//物品的信息提示
    ...
    public override void Awake()
    {
        ...
        bag = transform.Find("PlayerPackage/Package/Package").GetComponent<PanelRoleBag>();
        print("bag:" + bag);
        itemMouse = transform.Find("ItemMouse").GetComponent<ItemMouse>();
        print("itemMouse:" + itemMouse);
        itemMouseOldPos = itemMouse.transform.localPosition;
        print("itemMouseOldPos:" + itemMouseOldPos);
        rect = this.GetComponent<RectTransform>();
        print("rect:" + rect);
        itemInfo = transform.Find("ItemInfo").GetComponent<ItemMsg>();
