...
public class GunScript : MonoBehaviour
{
	...
	*/
    ...
    {// Running();  so i can find it with CTRL + F
        if (Input.GetAxis("Vertical") > 0 &&
            ...
            meeleAttack == false &&
            Input.GetAxisRaw("Fire1") == 0&&!Input.GetKey(KeyCode.Q)&&!Input.GetKey(KeyCode.E))
        {
	...
	*/
    ...
    private float weaponCrooketSpeed = 15f;
	...
	*/
    void RotationGun()
    {
        ...
        float nowAngleZ = Mathf.Lerp(AngleZ, WantAngleZ, Time.deltaTime * weaponCrooketSpeed);
        ...
        transform.RotateAround(PlayerBottom.position,transform.forward,nowAngleZ);
    }
